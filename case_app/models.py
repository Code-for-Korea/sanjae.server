...
class Ruling(models.Model):
    ...
    case_number = models.CharField(
        max_length=255, help_text='사건번호')  # 보통 13자 이내
    court_name = models.CharField(max_length=255, help_text='법원')  # 보통 11자 이내
    ruling_type = models.CharField(
        max_length=255, blank=True, help_text='판결유형')  # 보통 4자 이내
    case_type = models.CharField(
        max_length=255, blank=True, help_text='사건유형')  # 보통 7자 이내
    issue_category = models.CharField(
        max_length=255, blank=True, help_text='사고질병구분')  # 보통 7자 이내
    ...
    related_case = models.CharField(
        max_length=255, blank=True, help_text='연관사건')  # 보통 142자 이내
